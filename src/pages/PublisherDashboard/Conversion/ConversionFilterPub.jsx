...
import { pubConversionFilterBysearchParams } from "../../../Redux/PubConversionFilterSlice";

const ConversionFilterPub = ({isFilter, setIsFilter, setClickData, fetchData, sendDataToParent})=> {
    ...
    const handleSubmit = async(e)=> {
        e.preventDefault()
        const searchParamRes = await dispatch(pubConversionFilterBysearchParams({partners_Id: loggedIn?.partners_Id,publisherId: loggedIn?.publisherId, searchParams: searchParamValues}))
        ...
        <>
            <div className="sidebar-filter p-4">
                <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button className='btn btn-outline-secondary' onClick={()=> setIsFilter(false)}><i className="fa-solid fa-xmark fa-lg cursor-pointer"></i></button>
                </div>
                <hr />
...
export default ConversionFilterPub;