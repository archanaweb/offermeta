...
import { managerConversionFilterBysearchParams } from "../../../Redux/ManagerConversionFilterSlice";

const ConversionFilter = ({setIsFilter, setClickData, fetchData, sendDataToParent})=> {
    ...
    const handleSubmit = async(e)=> {
        e.preventDefault()
        const searchParamRes = await dispatch(managerConversionFilterBysearchParams({partners_Id: loggedUser?.partners_Id,managerId:  loggedUser?.managerId, searchParams: searchParamValues}))
