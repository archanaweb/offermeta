...
const PostbackTest = ()=> {
    ...
    const handleEventChange = (e)=>{
      ...
      setPostbackUrl(`https://postback.offersmeta.in/conversion/postback?m=${loogedIn?._id}&click_id=${trackingData.click_id}&secure=${advertiserDetail?.secure}&event_value=${e.target.value}`);
    }
    ...
    useEffect(() => {
      dispatch(fetchEventList({partners_Id:loogedIn._id, offerId: id}))
      dispatch(fetchOfferDetail({partners_Id:loogedIn._id ,offerId: id}))
    }, []);
    useEffect(() => {
