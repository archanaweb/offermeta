        ...
        <div className="container">
                ...
                <div className="row pt-2">
                    ...
                    <div className="col-lg-9">
                        {activeTab === 'showLandingPage' && <LandingPage offerId={id} />}
                        {activeTab === 'showOptimisationTool' && <OptimizationTool offerId={id} />}
                        {activeTab === 'tab3' && <><div>Tab3</div></>}
                        {activeTab === 'blockPub' && <BlockPublisher offerId={id} />}
                        {activeTab === 'tab5' && <><div>Tab4</div></>}
                        {activeTab === 'tab6' && <><div>Tab4</div></>}
                    </div>
                </div>
            </div>
        </div>
