...
const PixelLog = () => {
  ...
  useEffect(()=> {
    {startDate ? fetchData(`conversion/postbackLogs?partners_Id=${loggedUser._id}&page=${getCurrentPage}&startDate=${startDate}&endDate=${endDate}`): fetchData(`conversion/postbackLogs?partners_Id=${loggedUser._id}&page=${getCurrentPage}`)}
  },[getCurrentPage])

  const handleClickDate = ()=> {
    fetchData(`conversion/postbackLogs?partners_Id=${loggedUser._id}&page=${getCurrentPage}&startDate=${startDate}&endDate=${endDate}`);
  }
  useEffect(()=> {
