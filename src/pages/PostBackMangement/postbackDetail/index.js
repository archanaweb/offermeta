...
const PostbackDetail = ()=> {
    ...
    useEffect(()=> {
        ...
        dispatch(fetchOfferList({partners_Id:LoggedInUser._id,currentPage: 1}));
                        ...
                        <div className="col-lg-11">
                            <div className="offersData">
                                ...
                                <div className="offersDataItem">
                                    <p>Offer Id</p>
                                    {!isEditable ?
                                        <span>(ID: {postback?.offerId}) {postback?.offer}</span>
                                        :
                               ...
                               {formData?.event_value && <div className="offersDataItem">
                                    <p>Event value:</p>
                                        {!isEditable ?
                                        <span>{postback?.event_value}</span>
                                        :
